  ...
  class DraftFetch
    ...
    def update(upload_bundle, request_params)
      ...
      begin
        ...
        # Add to repo history
        remote_repo_url = upload_bundle.remote_repo_url
        ...
        ConnectorResult.new(
          message: { notice: I18n.t('connectors.dataverse.handlers.draft_fetch.message_success', title: metadata[:dataset_title]) },
          success: true
        )
        ...
        log_error('Error fetching draft dataset', { dataset_id: dataset_id }, e)
        error(I18n.t('connectors.dataverse.handlers.draft_fetch.message_error'))
      end
    end
